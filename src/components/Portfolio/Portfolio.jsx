    ...
    className={`paddings ${css.wrapper}`}>
      ...
      <div className={`innerWidth flexCenter ${css.container}`}>
        ...
        <motion.div variants={textVariant(.4)} className={`flexCenter ${css.heading}`}>
          <div>
            <span className="primaryText">Yangi loyihalarim</span>
            <p style={{marginTop: "10px"}}>Raqamli tajriba uchun mukammal yechim</p>
          </div>
          <span className="secondaryText">Koʻproq oʻrganing</span>
        </motion.div>
